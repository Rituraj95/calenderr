...
export default function Calneder1() {
  const customDays = [
    ...
    { day: '১', content: 'sept 19', color: 'white' },
    { day: '২', content: 'sept 20', color: 'white' },
    { day: '৩', content: 'sept 21', color: 'white' },

    { day: '৪', content: 'sept 22', color: 'white' },
    { day: '৫', content: 'sept 23', color: 'white' },
    { day: '৬', content: 'sept 24', color: 'red' },
    { day: '৭', content: 'sept 25', color: 'white' },
    { day: '৮', content: 'sept 26', color: 'white' },
    { day: '৯', content: 'sept 27', color: 'white' },
    { day: '১০', content: 'sept 28', color: 'white' },
    { day: '১১', content: 'sept 29', color: 'white' },
    { day: '১২', content: 'sept 30', color: 'white' },
    { day: '১৩', content: 'oct 1', color: 'red' },
    { day: '১৪', content: 'sept 2', color: 'white' },
    { day: '১৫', content: 'oct 3', color: 'white' },
    { day: '১৬', content: 'oct 4', color: 'white' },
    { day: '১৭', content: 'oct 5 ', color: 'white' },
    { day: '১৮', content: 'oct 6', color: 'white' },
    { day: '১৯', content: 'oct 7', color: 'white' },
    { day: '২০', content: 'oct 8', color: 'red' },
    { day: '২১', content: 'oct 9', color: 'white' },
    { day: '২২', content: 'oct 10', color: 'white' },
    { day: '২৩', content: 'oct 11', color: 'white' },
    { day: '২৪', content: 'oct 12', color: 'white' },
    { day: '২৫', content: 'oct 13', color: 'white' },
    { day: '২৬', content: 'oct 14', color: 'white' },
    { day: '২৭', content: 'oct 15', color: 'red' },
    { day: '২৮', content: 'oct 16', color: 'white' },
    { day: '২৯', content: 'oct 17', color: 'white' },
    { day: '৩০', content: 'oct 18', color: 'white' },
